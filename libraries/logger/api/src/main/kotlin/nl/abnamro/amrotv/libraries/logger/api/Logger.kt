 ...
 *
 * Inject [Logger] wherever logging is needed. Never use platform or third-party logging
 * APIs directly — all output is routed through registered log sinks.
 */
interface Logger {
     ...
     * @param throwable optional exception associated with the entry; null when no exception is involved.
     */
