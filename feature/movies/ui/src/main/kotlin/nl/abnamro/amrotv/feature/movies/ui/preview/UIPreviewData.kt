...
internal object UIPreviewData {
    ...
    object Movies {
        val darkKnight = MoviePresentationModel(
            id = 1,
        ...
        val inception = MoviePresentationModel(
            id = 2,
            title = "Inception",
            posterUrl = null,
            backdropUrl = null,
        ...
        val interstellar = MoviePresentationModel(
            id = 3,
            title = "Interstellar",
            posterUrl = null,
            backdropUrl = null,
        ...
        val shawshankRedemption = MoviePresentationModel(
            id = 4,
        ...
        val pulpFiction = MoviePresentationModel(
            id = 5,
            title = "Pulp Fiction",
            posterUrl = null,
            backdropUrl = null,
        ...
        val theMatrix = MoviePresentationModel(
            id = 6,
            title = "The Matrix",
            posterUrl = null,
            backdropUrl = null,
        ...
        val goodfellas = MoviePresentationModel(
            id = 7,
            title = "Goodfellas",
            posterUrl = null,
            backdropUrl = null,
        ...
        val oppenheimer = MoviePresentationModel(
            id = 8,
            title = "Oppenheimer",
            posterUrl = null,
            backdropUrl = null,
        ...
        val dunePartTwo = MoviePresentationModel(
            id = 9,
            title = "Dune: Part Two",
            posterUrl = null,
            backdropUrl = null,
        ...
        val everythingEverywhereAllAtOnce = MoviePresentationModel(
            id = 10,
        ...
        val all = persistentListOf(
            darkKnight, inception, interstellar, shawshankRedemption, pulpFiction,
            theMatrix, goodfellas, oppenheimer, dunePartTwo, everythingEverywhereAllAtOnce,
        )
    }

    object MovieDetails {
        val darkKnight = MovieDetailPresentationModel(
            id = 155,
            title = "The Dark Knight",
        ...
        val interstellar = MovieDetailPresentationModel(
            id = 157336,
            title = "Interstellar",
            ...
            backdropUrl = null,
            genres = persistentListOf(
                GenrePresentationModel(878, "Science Fiction"),
                GenrePresentationModel(12, "Adventure"),
                GenrePresentationModel(18, "Drama"),
            ),
            overview = """
