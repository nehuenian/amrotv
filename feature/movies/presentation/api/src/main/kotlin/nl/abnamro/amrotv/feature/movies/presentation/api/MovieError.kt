 ...
 *
 * The UI layer maps each entry to an Android string resource, keeping hardcoded strings out of the
 * domain and presentation layers and enabling proper localisation.
 */
