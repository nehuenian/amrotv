...
class MovieDetailDomainToPresentationMapper @Inject constructor(
    private val genreMapper: GenreDomainToPresentationMapper,
) : Mapper<MovieDetail, MovieDetailPresentationModel> {

    override fun map(input: MovieDetail) = MovieDetailPresentationModel(
        id = input.id,
        title = input.title,
