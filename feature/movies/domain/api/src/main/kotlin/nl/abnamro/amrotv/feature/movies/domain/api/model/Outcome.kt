 ...
 *
 * A [Success] result carries fresh or cached data. An [Error] result signals a failure
 * and may carry stale [Error.data] from a previous successful fetch, allowing the UI to remain
 * functional while surfacing the error to the user.
 */
