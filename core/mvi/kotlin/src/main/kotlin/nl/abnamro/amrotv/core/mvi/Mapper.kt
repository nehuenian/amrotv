 ...
 *
 * Every mapper class in the project must implement this interface to ensure a
 * uniform mapping API. Do not use extension functions for mapping — create an
 * injectable class that implements [Mapper] instead.
 *
