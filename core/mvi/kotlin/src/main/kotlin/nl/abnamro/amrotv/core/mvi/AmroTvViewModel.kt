 ...
 * State transitions are applied inside [handleIntent] via [StateReducer] factories,
 * keeping pure state logic isolated and independently testable.
...
interface AmroTvViewModel<S : MviState, I : MviIntent, E : MviEffect> {
     ...
     *
     * Implementations route the intent to the appropriate async work, state transitions
     * (via [StateReducer] factories), and one-shot effects.
     *
